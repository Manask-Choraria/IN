...
var gameOverimg,reset,resetImg,coinSound,gameOverSound,resetTap,obstacleTouchingSound;
var playerStop
var score = 0;
var gameState = "play";
function preload(){
...
if(player.x)
  if(keyDown(LEFT_ARROW) || (touches.length>0 && touches[x] < displayWidth/2))
  {
    player.x -= 150;
  }

  if(keyDown(RIGHT_ARROW) || (touches.length>0 && touches[x] > displayWidth/2))
  {
    player.x += 150;
  }
